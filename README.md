...
5. Тк данные для в слайсе преобразовываются в нужный формат не сразу, добавлены скелетоны для отображения карточек тарифов и динамический импорт.
6. Для отображения картинок применятся компонента Image Next.js
