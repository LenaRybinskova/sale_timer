...
export default function ItemDiscount({
    ...
    return (
        <div className={'flex flex-col items-center w-[210px] h-[197px] justify-start border-[2px] border-border rounded-[22px] p-[27px] relative before:content-[""] before:absolute before:top-1/2 before:left-0 before:right-0 before:w-[134px] before:h-0.5 before:bg-text-muted before:-translate-y-1/2 before:mx-auto'}>


            <div className={'flex items-center justify-center font-normal text-[26px] leading-[100%]'}>
            ...
            <p className="font-bold text-[20px] leading-[110%] relative inline-block overflow-hidden
